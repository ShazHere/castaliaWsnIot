...
void Radio::readIniFileParameters(void)
{
	...
	string startingTxPower = par("TxOutputPower"); //it was local variable, made it class level so that I can access it outside
	this->startingTxPower = startingTxPower;
